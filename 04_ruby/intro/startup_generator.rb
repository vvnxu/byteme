...
# puts('hello is your startup ' + this_array.sample + ' ' + that_array.sample)

# interpolation / string templates
puts "hello is your startup #{this_array.sample} for #{that_array.sample}?"
